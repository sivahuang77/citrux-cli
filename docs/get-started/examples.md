...
Not sure where to get started with Citrux CLI? This document covers examples on
how to use Citrux CLI for a variety of tasks.
...
Give Citrux CLI the following prompt:
...
Citrux CLI will return an explanation based on the actual source code:
...
Result: Citrux CLI will read each file and then ask for permission to write a
new file. Provide your permission and Citrux CLI will provide the following
.csv:
...
Result: Citrux CLI will ask for permission to write a new file and create a test
for your login page
