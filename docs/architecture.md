# Citrux CLI Architecture Overview

This document provides a high-level overview of the Citrux CLI's architecture.

## Core components

The Citrux CLI is primarily composed of two main packages, along with a suite of
tools that can be used by the system in the course of handling command-line
input:

1.  **CLI package (`packages/cli`):**
    - **Purpose:** This contains the user-facing portion of the Citrux CLI, such
...
2.  **Core package (`packages/core`):**
    - **Purpose:** This acts as the backend for the Citrux CLI. It receives
...
A typical interaction with the Citrux CLI follows this flow:
