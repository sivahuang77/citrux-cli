...
Headless mode allows you to run Citrux CLI programmatically from command line
...
The headless mode provides a headless interface to Citrux CLI that:
...
Pipe input to Citrux CLI from your terminal:
