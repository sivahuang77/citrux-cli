...
- **⚡️⚡️⚡️ Gemini 3 Flash + Citrux CLI:** Better, faster and cheaper than 2.5
...
- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Citrux CLI with your Workspace data. Write
...
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Citrux CLI. This allows users and administrators to create
...
- **Gemini 3 + Citrux CLI:** launch 🚀🚀🚀
- **Data Commons Citrux CLI Extension** - A new Data Commons Citrux CLI
...
- **🎉 Seamless scrollable UI and mouse support:** We’ve given Citrux CLI a
...
![Codebase investigator subagent in Citrux CLI.](https://i.imgur.com/4J1njsx.png)
...
- **Model routing:** Citrux CLI will now intelligently pick the best model for
...
![Citrux CLI and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **Citrux CLI Jules Extension:** Use Citrux CLI to orchestrate Jules. Spawn
...
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Citrux CLI’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Citrux CLI.
...
- **Interactive Shell Tool calling:** Citrux CLI can now also execute
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `gemini` 😎 directly in Citrux CLI:
  - Blog:
...
- 🎉 **Announcing Citrux CLI Extensions** 🎉
  - Completely customize your Citrux CLI experience to fit your workflow.
  - Build and share your own Citrux CLI extensions with the world.
  ...
  - Everything you need to know:
    [Now open for building: Introducing Citrux CLI extensions](https://blog.google/technology/developers/gemini-cli-extensions/).
...
- 🎉**Build your own Citrux CLI IDE plugin:** We've published a spec for
...
- 🎉 **Citrux CLI extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Citrux CLI
    ([extension](https://github.com/gemini-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Citrux CLI
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for Citrux CLI!
  - **Announcement:**
...
- 🎉**Citrux CLI Databases and BigQuery Extensions:** Connect Citrux CLI to all
  of your cloud data with Citrux CLI.
...
- **JSON output mode:** Have Citrux CLI output JSON with `--output-format json`
...
- 🎉**FastMCP + Citrux CLI**🎉: Quickly install and manage your Citrux CLI MCP
...
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Citrux CLI
...
- **Edit Tool improvements:** Citrux CLI’s ability to edit files should now be
...
- 🎉**Citrux CLI CloudRun and Security Integrations**🎉: Automate app deployment
...
- **Experimental**
  ...
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Citrux CLI to continue conversations on your behalf. This may be
