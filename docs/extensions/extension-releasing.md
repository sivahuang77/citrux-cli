...
Citrux CLI extensions can be distributed through
...
To ensure Citrux CLI can automatically find the correct release asset for each
...
Citrux CLI extension for multiple platforms:
