...
create a custom command, and provide context to the model with a `CITRUX.md`
file.
...
## Step 5: Add a custom `CITRUX.md`

You can provide persistent context to the model by adding a `CITRUX.md` file to
...
1.  Create a file named `CITRUX.md` in the root of your extension directory:
...
Restart the CLI again. The model will now have the context from your `CITRUX.md`
