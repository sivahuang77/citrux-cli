...
describe('initCommand', () => {
  ...
  const geminiMdPath = path.join(targetDir, 'CITRUX.md');
  ...
  it('should inform the user if CITRUX.md already exists', async () => {
  ...
  it('should create CITRUX.md and submit a prompt if it does not exist', async () => {
    ...
    expect(mockContext.ui.addItem).toHaveBeenCalledWith(
      {
        type: 'info',
        text: 'Empty CITRUX.md created. Now analyzing the project to populate it.',
      },
      expect.any(Number),
    );
