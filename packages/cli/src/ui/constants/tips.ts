...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .citruxignore files in context (/settings)...',
  ...
  'Create a project-specific CITRUX.md file with /init...',
  ...
  'Reload instructional context from CITRUX.md files with /memory refresh...',
  'List the paths of the CITRUX.md files in use with /memory list...',
