...
describe('Trusted Folders Loading', () => {
  ...
  it('should use CITRUX_CLI_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['CITRUX_CLI_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['CITRUX_CLI_TRUSTED_FOLDERS_PATH'];
  });
