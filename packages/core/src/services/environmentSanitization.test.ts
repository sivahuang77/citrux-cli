...
describe('sanitizeEnvironment', () => {
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      ...
      // Stripe
      STRIPE_SK_LIVE: 'sk_live_REDACTED_REDACTED_REDACTED',
      STRIPE_RK_LIVE: 'rk_live_REDACTED_REDACTED_REDACTED',
      STRIPE_SK_TEST: 'sk_test_REDACTED_REDACTED_REDACTED',
      STRIPE_RK_TEST: 'rk_test_REDACTED_REDACTED_REDACTED',
      // Slack
