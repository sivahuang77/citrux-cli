...
const OAUTH_CLIENT_ID =
  process.env['CITRUX_GOOGLE_OAUTH_CLIENT_ID'] || 'REDACTED_CLIENT_ID.apps.googleusercontent.com';

// OAuth Secret value used to initiate OAuth2Client class.
const OAUTH_CLIENT_SECRET = process.env['CITRUX_GOOGLE_OAUTH_CLIENT_SECRET'] || 'REDACTED_CLIENT_SECRET';
