# RFC: Citrux CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the Citrux CLI agent, this document
...
required for rich, interactive workflows with the Citrux CLI agent.

### 1.2 Motivation

Recent work integrating Citrux CLI with clients like Zed and Gemini Code
...
- **Ecosystem Alignment**: Aligns Citrux CLI with a growing industry standard,
...
workflows between a client and the Citrux CLI agent. It consists of a
...
// Configuration settings for the Citrux CLI agent.
